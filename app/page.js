      ...
      <div id="pricing" style={{ padding: '60px 40px 0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', maxWidth: '560px', margin: '0 auto' }}>
          <div style={{ background: '#22222c', border: '0.5px solid rgba(255,255,255,0.06)', borderRadius: '12px', padding: '24px' }}>
            ...
            <a href="https://app.sorano.space/login" style={{ display: 'block', textAlign: 'center', padding: '9px', borderRadius: '8px', fontSize: '13px', cursor: 'pointer', fontWeight: '500', background: 'transparent', border: '0.5px solid rgba(255,255,255,0.08)', color: '#666', textDecoration: 'none' }}>Get started</a>
          ...
          <div style={{ background: '#22222c', border: '0.5px solid rgba(127,119,221,0.3)', borderRadius: '12px', padding: '24px' }}>
            ...
            <a href="https://app.sorano.space/login" style={{ display: 'block', textAlign: 'center', padding: '9px', borderRadius: '8px', fontSize: '13px', cursor: 'pointer', fontWeight: '500', background: '#fff', border: 'none', color: '#1c1c24', textDecoration: 'none' }}>Upgrade to Pro</a>
            <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
